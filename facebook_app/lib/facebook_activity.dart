...
void main() {
  runApp(MaterialApp(
    ...
    home: facebook_activity(),
  ));

}
class facebook_activity extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
    return Scaffold(
        ...
        Row( //ROW TWO
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child:Text("Off-Facebook activity",
                  style: TextStyle(
                    fontSize: 18,
      ...
      Container(
        ...
        child:Text("Off-Facebook activity includes information that businesses and organisations share with us about your interactions with them, such as visiting their apps or websites.",
            style: TextStyle(
              fontSize: 13,
      ...
      Container(
        margin: EdgeInsets.fromLTRB(0, 20, 290, 0 ),
      ...
      Container(
        ...
        child: const Text('View and Manage Activity'),
      ),
      ),
      Container(
        margin: EdgeInsets.fromLTRB(0, 0, 310, 0 ),
        child:Text("Privact Tips",
            style: TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w500,
              color: Colors.black,
