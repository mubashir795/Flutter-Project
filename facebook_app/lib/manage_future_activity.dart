...
void main() {
  runApp(MaterialApp(
    ...
    home: manage_future_activity(),
  ));

}
class manage_future_activity extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
    return Scaffold(
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child:Text("Manage Future Activity",
                  style: TextStyle(
                    fontSize: 18,
      ...
      Container(
        ...
        child:Text("Future Off-Facebook Activity",
            style: TextStyle(
              fontSize: 14,
          ...
          Container(
            ...
            child: IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  apps_and_website()),
                );
              },
          ...
          Container(
            ...
            child: IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  public_posts()),
                );
              },
